...
export default function LoginPage() {
  // Explicitly typing as Variants and using "as const" for the ease string
  ...
  return (
    <div className="grid min-h-svh w-full lg:grid-cols-2 bg-background overflow-x-hidden">
      ...
      >
        <motion.div variants={itemVariants} className="flex justify-between items-center md:justify-start gap-2">
          ...
          >
            <blockquote className="space-y-2">
              <p className="text-lg font-medium italic">
                "ResuMi has completely transformed how I track my applications. The AI insights are a game changer."
              </p>
              <footer className="text-sm opacity-80">— Alex Rivera, Senior Developer</footer>
            </blockquote>
          </motion.div>
        </div>
